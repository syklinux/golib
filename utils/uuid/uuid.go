// Package uuid generates random uni string
//
// Example usage:
//
// s := uuid.New() // s is now "apHCJBl7L1OmC57n"
//
...
const (
	// Standard length of uuid string to achive ~95 bits of entropy.
	StdLen = 16
...
// Standard characters allowed in uuid string.
